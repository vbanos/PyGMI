...
class Connect_Instrument():
    ...
    def initialize(self):
        ...
        output gain is 0dB O5 setting
        
        Input gain is a parameter calculated by microphone sensitivity
